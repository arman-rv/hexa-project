  ...
  return (
    <div className={' '+className}>
      ...
      <div className={"relative w-[416px] h-[50px] rounded-xl overflow-hidden bg-[#F9F6FF] dark:bg-newPurpleAlpha2 dark:bg-darkblue2 "+ inputDivClass}  >
        ...
        <input type="email" className='w-full h-full text-left px-4 bg-[transparent] placeholder:text-[#0002] text-[#181355] dark:text-semiWhite dark:placeholder:text-whitePink '  placeholder='example@gmail.com'/>
      </div>
    </div>
  )
}
